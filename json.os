...
Функция Тип(ИмяТипа)
	Возврат ""; //TODO вставлена для прохождения компиляции
КонецФункции

Функция ТипЗнч(Значение)
	Возврат ""; //TODO вставлена для прохождения компиляции
КонецФункции

Функция ЗначениеИзСтрокиВнутр(Значение)
	Возврат ""; //TODO вставлена для прохождения компиляции
КонецФункции

Функция Формат(Значение, ФорматнаяСтрока)
	Возврат ""; //TODO вставлена для прохождения компиляции 
КонецФункции

Функция Base64Строка(Строка)
	Возврат ""; //TODO вставлена для прохождения компиляции
КонецФункции
...
Функция jsonЗаписать(Значение, Стандарт, ПредставленияСсылок, ВспомогательныеДанные, Колонки, Смещение, Отступ, Табуляция, ПереносСтроки, ПолноеМаскированиеСимволов, МаскированиеКириллицы)
	...
	Если ВспомогательныеДанные.ПримитивныеТипы.СодержитТип(Тип) Тогда 
		//#Если ВебКлиент Или ТонкийКлиент Тогда
		Если (Значение = "") Или (Значение = Неопределено) Тогда 
			Возврат "null";
